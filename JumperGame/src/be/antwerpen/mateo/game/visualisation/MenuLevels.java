...
public class MenuLevels implements menuInterfaceStrat {
    private j2dContext grCtx;

    public MenuLevels(j2dContext gr) {
        this.grCtx = gr;
    }
    ...
    public void execute(int state) {
        ...
        if (g2d != null) {
            ...
            grCtx.getG2d().drawString(" Level1 ",StringX+10,(size*3)+10);
            grCtx.getG2d().drawString(" Level2 ",StringX-5,(size*7)+10);
            grCtx.getG2d().drawString(" LevelX ", StringX-5,(size*11)+10);
            grCtx.getG2d().drawString(" Go Back", StringX-5,(size*15)+10);
        }
        else{
